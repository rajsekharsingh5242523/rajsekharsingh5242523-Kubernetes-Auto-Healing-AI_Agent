...
def query_ollama(incident_context):
    ...
    system_prompt = """
You are a Kubernetes SRE incident diagnosis assistant.
...
{
  "incident_type": "OOMKilled" or "CrashLoopBackOff",
  "root_cause": "short explanation",
  "action": "increase_memory" or "no_action",
...
Rules:
- If the container is OOMKilled or repeatedly crashing because of memory,
  recommend increase_memory.
- The only allowed remediation action is increase_memory.
- Do not invent kubectl commands.
